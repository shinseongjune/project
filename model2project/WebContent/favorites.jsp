...
<%
				ArrayList<Lecture> lecList = favorList[1];
				ArrayList<Member> memList = favorList[2];
...
%>
			...
			<div class="sidebar">
				<div class="bigMyPage">My Page</div>
				<div>
					<div class="myPageMenu"><a href="editprofile.do"><img src="images/user_icon.png">&nbsp;개인정보 수정</a></div>
					<div class="myPageMenu on"><a href="favorites.do"><img src="images/heart_icon.png">&nbsp;즐겨찾기 목록</a></div>
					<div class="myPageMenu"><a href="review.do"><img src="images/star_icon.png">&nbsp;리뷰남기기</a></div>
					<div class="myPageMenu"><a href="messanger.do"><img src="images/mail_icon.png">&nbsp;쪽지함</a></div>
					<div class="myPageMenu"><a href="quit.jsp"><img src="images/x_mark_icon.png">&nbsp;회원 탈퇴</a></div>
				</div>
			</div>
			<div class="contents">
				<div class="my-3 p-3 bg-white rounded box-shadow">
			        ...
			        <div class="media text-muted pt-3">
			          ...
			          <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
			            <div class="d-flex justify-content-between align-items-center w-100">
			              <strong class="text-gray-dark">즐겨찾기에 등록된 강의가 없습니다.</strong>
			            </div>
			          </div>
			        </div>
			    </div>

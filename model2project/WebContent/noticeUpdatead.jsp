			...
			<div class="contents">
				...
				<form method="post" action="noticeUpdate.do">
					<div class="row justify-content-center mb-5">
								...
								<ul class="bbsViewWrapperList">
									...
									<li class="bbsViewTitle">
										<ul>
											...
											<li class="bbsViewTitleText"><input type="text" class="form-control" name="title" required="required" autocomplete="none" value="<%=not.getTitle() %>" autocomplete="off" /></li>
										</ul>
									</li>
									<li class="bbsViewBody">
										<div>
											<textarea cols="50" rows="10" style="resize: none;" class="form-control" name="contents"><%=not.getContents() %></textarea>
										</div>
									</li>
								</ul>
							</div>
						...
						<input type="hidden" name="notice_num" value="<%=not.getNotice_num() %>" />

		...
		<nav class="navbar navbar-expand-sm navbar-dark bg-dark fixed-top">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item active"><a class="nav-link" href="editProfile.jsp">마이페이지
...
%>
	<div class="editcont">
			<div class="sidebar">
				...
				<div>
					<div class="myPageMenu on"><a href="editprofile.jsp"><img src="images/user_icon.png">&nbsp;개인정보 수정</a></div>
